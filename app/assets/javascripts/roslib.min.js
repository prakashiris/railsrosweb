! function() {
    ...
    5: [function(a, b, c) {
        ...
        b.exports = function(a, b) {
            ...
            var o = Math.floor(Math.pow(16, 8) * Math.random()).toString(16),
                p = {};
            p[h] = h, e[o] = ["function(require,module,exports){var f = require(" + g(h) + ");(f.default ? f.default : f)(self);}", p];
            var q = {};
            c(o);
    ...
    15: [function(a, b, c) {
        ...
        d.prototype.__proto__ = k.prototype, d.prototype.connect = function(a) {
            if ("socket.io" === this.transportLibrary) this.socket = j(io(a, {
                "force new connection": !0
            }), g(this)), this.socket.on("connect", this.socket.onopen), this.socket.on("data", this.socket.onmessage), this.socket.on("close", this.socket.onclose), this.socket.on("error", this.socket.onerror);
            else if ("RTCPeerConnection" === this.transportLibrary.constructor.name) this.socket = j(this.transportLibrary.createDataChannel(a, this.transportOptions), g(this));
    ...
    16: [function(a, b, c) {
        function d(a) {
            a = a || {}, this.ros = a.ros,
                this.name = a.name, this.serviceType = a.serviceType, this.isAdvertised = !1, this._serviceCallback = null
        }
    ...
    20: [function(a, b, c) {
        function d(a) {
            a = a || {}, this.ros = a.ros, this.name = a.name, this.messageType = a.messageType, this.isAdvertised = !1, this.compression = a.compression || "none", this.throttle_rate = a.throttle_rate || 0, this.latch = a.latch || !1, this.queue_size = a.queue_size || 100, this.queue_length = a.queue_length || 0, this.reconnect_on_close = void 0 === a.reconnect_on_close || a.reconnect_on_close, this.compression && "png" !== this.compression && "cbor" !== this.compression && "none" !== this.compression && (this.emit("warning", this.compression + " compression is not supported. No compression will be used."), this.compression = "none"), this.throttle_rate < 0 && (this.emit("warning", this.throttle_rate + " is not allowed. Set to 0"), this.throttle_rate = 0);
            var b = this;
    ...
    47: [function(a, b, c) {
        function d(a) {
            this.socket_ = e(f), this.socket_.addEventListener("message", this.handleWorkerMessage_.bind(this)), this.socket_.postMessage({
                uri: a
            })
        }
        var e = a("webworkify"),
        ...
        d.prototype.handleWorkerMessage_ = function(a) {
            var b = a.data;
            if (b instanceof ArrayBuffer || "string" == typeof b) this.onmessage(a);
            else {
                var c = b.type;
        ...
        b.exports = function(a) {
            ...
            a.addEventListener("message", function(a) {
                ...
                if ("string" == typeof f) e.send(f);
                    ...
                    if (!f.hasOwnProperty("uri")) throw "Unknown message to WorkerSocket";
                    var g = f.uri;
                    e = new d(g), e.binaryType = "arraybuffer", e.onmessage = b, e.onclose = c, e.onopen = c, e.onerror = c
                }
            })
        }
    }, {
